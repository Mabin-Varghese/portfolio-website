...
const Contact = () => {
  ...
  useEffect(() => {
    if (Object.keys(formErrors).length === 0 && isSubmit) {
      emailjs.sendForm('service_0qnh8kh', 'template_85zi4d6', Form.current, '3OZE-UXyXBuzDY4da')
          .then((result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          <article className="contact__option">
            ...
            <h4>Email</h4>
            {/* <h5>mabinvarghese23@gmail.com</h5> */}
            <a href="mailto:mabinvarghese23@gmail.com" target='_blank' rel="noreferrer">Send a Email</a>
          </article>

          <article className="contact__option">
            <FiPhoneCall className='contact_option-icon'/>
            <h4>Call</h4>
            {/* <h5>Mabin Varghese</h5> */}
            <a href="tel:+91-8157873401" target='_blank' rel="noreferrer">Call Me</a>
          </article>
          ...
          <article className="contact__option">
            ...
            <h4>Whatsapp</h4>
            {/* <h5>+91 ****</h5> */}
            <a href="https://wa.me/+918157873401?text=More Info" target='_blank' rel="noreferrer">Send a message</a>
          </article>
        </div>
